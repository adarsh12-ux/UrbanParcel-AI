        ...
        <div className="relative border-l border-slate-200 pl-2 sm:pl-3">
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              <p className="text-xs font-semibold text-slate-900 leading-none truncate max-w-[120px]">{user?.name || 'Adarsh Sharma'}</p>
              <p className="text-[10px] font-mono text-slate-500 leading-none mt-0.5">{user?.id || 'AP-REV-2024'}</p>
            </div>
            ...
            <div className="absolute top-full right-0 mt-1 w-72 bg-white border border-slate-200 rounded shadow-lg z-50 py-2 space-y-2 text-xs">
              <div className="px-3 pb-2 border-b border-slate-100 space-y-1">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-900 text-xs">{user?.name || 'Adarsh Sharma'}</span>
                ...
                <p className="text-[11px] text-slate-600">{user?.designation || 'Senior Cadastral Surveyor'}</p>
                ...
                <div className="pt-1 flex items-center gap-1.5 text-[10px] text-slate-400 font-mono">
                  ...
                  <span>ID: {user?.id || 'AP-REV-2024'}</span>
                </div>
              </div>
